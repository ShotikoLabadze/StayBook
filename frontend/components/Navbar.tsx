  ...
  return (
    <>
      <nav className="w-full h-20 bg-[var(--color-card-bg)] border-b border-[var(--color-border-subtle)] flex items-center justify-between px-4 sm:px-8 sticky top-0 z-50 transition-colors duration-300">
        ...
        <div className="flex items-center gap-3 sm:gap-5">
          ...
          <button
            ...
            className="flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-secondary text-primary font-extrabold text-xs sm:text-sm rounded-xl shadow-sm hover:bg-opacity-90 transition-all cursor-pointer border-none whitespace-nowrap"
          >
      ...
      <ShareTripModal
        ...
        tripId={params?.tripId as string | undefined}
        trips={trips}
      />
    </>
  );
