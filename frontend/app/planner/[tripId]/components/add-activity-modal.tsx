    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center font-body">
      ...
      <div className="relative bg-card-bg w-full max-w-md p-6 rounded-2xl border border-border-subtle shadow-2xl z-50 text-left animate-in fade-in zoom-in-95 duration-150 transition-colors duration-300">
        <header className="flex items-center justify-between border-b border-border-subtle pb-3 mb-4">
          <div>
            <h3 className="text-sm font-bold text-primary">Add New Plan</h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className="w-full rounded-xl border border-border-subtle bg-neutral-bg px-3 py-2 text-xs font-medium outline-none focus:border-secondary transition-colors text-primary placeholder:text-text-muted"
            />
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <textarea
              ...
              rows={3}
              className="w-full rounded-xl border border-border-subtle bg-neutral-bg px-3 py-2 text-xs font-medium outline-none focus:border-secondary transition-colors text-primary resize-none placeholder:text-text-muted"
            />
          </div>
